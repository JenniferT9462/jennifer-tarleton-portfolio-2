...
const Hero = () =>  {
   const [currentSection, setCurrentSection] = useState("home");
    ...
    return (
      ...
      <section className="h-screen flex items-center justify-center text-white p-6">
            <motion.div
            ...
            >
              ...
              <div className="flex justify-center space-x-6">
                <a href="https://github.com/JenniferT9462" target="_blank" className="text-white hover:text-gray-200">
                  <FaGithub size={32} />
                </a>
                <a href="https://www.linkedin.com/in/jennifer-tarleton-11290350/" target="_blank" className="text-white hover:text-gray-200">
                  <FaLinkedin size={32} />
                </a>
              </div>
            </motion.div>
